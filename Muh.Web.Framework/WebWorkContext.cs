...
namespace Muh.Web.Framework
{
    public partial class WebWorkContext : IWorkContext
    {
        ...
        private const string CustomerCookieName = "Muh.customer";
            ...
            get
            {
                ...
                if (detectedLanguage != null)
                {
                    ...
                    if (this.CurrentCustomer.GetAttribute<int>(SystemCustomerAttributeNames.LanguageId,
                        _genericAttributeService, 0) != detectedLanguage.Id)
                    {
                        _genericAttributeService.SaveAttribute(this.CurrentCustomer, SystemCustomerAttributeNames.LanguageId,
                            detectedLanguage.Id, 0);
                    }
                }

                var allLanguages = _languageService.GetAllLanguages(storeId: 0);
